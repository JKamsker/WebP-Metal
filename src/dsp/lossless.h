...
// Indirection used by the optional Metal lossless preprocessor.
...
// Installs the Metal implementation when a suitable device is available.
// The C implementation remains installed otherwise.
void VP8LEncDspInitMetal(void);
